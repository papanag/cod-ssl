...
def main() -> None:
    ...
    p.add_argument("--split-train", help="existing 4,040-row train manifest to split")
    ...
    if a.split_train:
        ...
        if len(frame) != 4040: raise ValueError(f"expected 4040 training rows, got {len(frame)}")
